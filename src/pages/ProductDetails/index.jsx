      ...
      .then((snapshot) => {
        ...
        for (let i = 0; i < 5; i++) {
          ...
          const processedItem = {
            ...randomItem,
            price:
              randomItem.prices[Object.keys(randomItem.prices)[0]][
                Object.keys(
                  randomItem.prices[Object.keys(randomItem.prices)[0]]
                )[0]
              ].price,
          ...
          <div>
            ...
            <div className="mt-8">
              ...
              <button
                ...
                onClick={() => setTab(2)}
              >
                Reviews <sup>{item.reviews?.length}</sup>
              </button>
            </div>
              ...
              {tab === 1 ? (
                <div className="grid grid-cols-2 gap-16">
                  <div className="mt-12">
                    ...
                    <div>
                      <h1 className="font-semibold text-xl mt-8 text-gray-700">
                        Return
                      </h1>
                      <p className="text-gray-600 leading-loose mt-4">
                        You have 60 days to return the item(s) using any of the
                        following methods:
                      </p>
                  ...
                  <div className="text-gray-700 mr-10">
                    ...
                    <div
                      ...
                      } gap-3 transition-all duration-300 mt-4`}
                    >
                    ...
                    <div>
                      <input
                        type="number"
                        className="w-32 mt-8 border border-gray-500 rounded px-4 py-3"
                        min={1}
                        value={quantity}
                      ...
                      <button
                        ...
                        className="bg-gray-900 text-white px-16 py-4 rounded-full ml-4"
                      >
                        Add to Cart
                      </button>
                    </div>
                      ...
                      <div className="relative mt-8">
                        ...
                        {itemTab === 1 ? (
                          ...
                          <div>
                            ...
                            <p>
                              Free standard shipping on orders over $35 before
                            ...
                            <table className="table-auto w-full mt-4">
                              ...
                              <tbody>
                                <tr>
                                  <td className="border-t px-8 py-3 text-sm">
                                    Standard
                                  </td>
                                  <td className="border-t px-8 py-3 text-sm">
                                    $0.00
