    ...
    <div className="relative">
        ...
        <div className="w-full px-4 py-16">
            ...
            <div className='grid grid-cols-5 gap-20 place-items-center px-48'>
                <a href="/product-list"><img src={NikeLogo} alt="Nike Logo" className="object-contain w-32 h-32" /></a>
                <a href="/product-list"><img src={AdidasLogo} alt="Adidas Logo" className="object-contain w-32 h-32" /></a>
                <a href="/product-list"><img src={GucciLogo} alt="Gucci Logo" className="object-contain w-32 h-24" /></a>
                <a href="/product-list"><img src={LouisVuittonLogo} alt="Louis Vuitton Logo" className="object-contain w-32 h-24" /></a>
                <a href="/product-list"><img src={ChanelLogo} alt="Chanel Logo" className="object-contain w-32 h-24" /></a>
            </div>
        </div>
        ...
        <div className="w-full bg-hihiclothes-2 mt-0 flex cursor-pointer">
            <div className='relative w-1/2'>
                <div className="text-hihiclothes-3 absolute inset-x-0 bottom-0 text-right py-8 px-8">
                    ...
                    <h1 className='text-5xl font-semibold'>AUTUMN 2022 COLLECTION</h1>
                </div>
            </div>
            <div className="w-1/2">
        ...
        <div className="w-full px-16 py-16 grid grid-cols-4 gap-12 tracking-widest">
            <div className="w-full col-span-2 flex bg-[#DAE5E3] cursor-pointer" onClick={() => window.location = "/product-list"}>
            ...
            <div style={{ backgroundImage: `url(${Sneakers})` }} className='col-span-2 row-span-2 bg-cover relative cursor-pointer' onClick={() => window.location = "/product-list"}>
            ...
            <div className="w-full col-span-2 flex bg-[#FCEBE2] cursor-pointer" onClick={() => window.location = "/product-list"}>
                <div className="w-1/2">
            ...
            <div className='bg-[#F7F8FA] cursor-pointer' onClick={() => window.location = "/product-list"}>
            ...
            <div className='w-full col-span-2 flex bg-[#C1E4DE] cursor-pointer' onClick={() => window.location = "/product-list"}>
            ...
            <div style={{ backgroundImage: `url(${Glasses})` }} className="bg-cover bg-bottom cursor-pointer" onClick={() => window.location = "/product-list"}>
